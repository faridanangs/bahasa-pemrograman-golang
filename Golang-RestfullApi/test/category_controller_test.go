...
func setupTestDB() *sql.DB {
	db, err := sql.Open("mysql", "root@tcp(localhost:3306)/golang_resapi_test")
...
func TestListCategoriesSuccess(t *testing.T) {
	...
	responses := responseBody["data"].([]interface{})

	categoryResponse1 := responses[0].(map[string]interface{})
	categoryResponse2 := responses[1].(map[string]interface{})
